...
public class SystemRoleComponentEditTests : IClassFixture<CustomWebApplicationFactoryFixture>
{
    [Fact]
    public async Task EditSystemRole()
    {
        ...
        var actualResponse = await client.PutAsync("/api/v1/system-role/edit", httpContent);
