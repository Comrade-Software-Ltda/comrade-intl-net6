...
public class SystemPermissionDeleteCoreHandler : IRequestHandler<SystemPermissionDeleteCommand, ISingleResult<Entity>>
{
    ...
    public SystemPermissionDeleteCoreHandler(ISystemPermissionDeleteValidation deleteValidation, ISystemPermissionRepository repository, IMongoDbCommandContext mongoDbContext)
    {
    ...
    public async Task<ISingleResult<Entity>> Handle(SystemPermissionDeleteCommand request, CancellationToken cancellationToken)
    {
